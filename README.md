...
- **Toolbar**: "GoSend" title (blue), vertical separator, then **Transfer Queue**, **Refresh Discovery**, **Discover**, and (right-aligned) **Settings**. Toolbar background uses the theme mantle color, with a thin (1px) divider line below it.
